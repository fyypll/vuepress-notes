...
module.exports = {
  ...
  themeConfig: {
    nav: [
      { text: '首页', link: '/' },
      {
        text: 'Vue', link: '/pages/a2f161/', items: [
      ...
      {
        text: 'JavaScript', link: '/pages/a20ce8/', items: [
      ...
      { text: 'Node.js', link: '/pages/db78e2/' },
      { text: 'CSS', link: '/pages/5d571c/' },
      { text: '实用工具', link: '/pages/3403e9/' },
      {
        text: '工具配置', link: '/pages/9cc27d/', items: [
          { text: '使用pnpm管理node版本', link: '/pages/9cc27d/' }
        ]
      },
    ],
    sidebarDepth: 2, // 侧边栏显示深度，默认1，最大2（显示到h3标题）
    logo: '/img/logo.png', // 导航栏logo
    repo: 'https://github.com/fyypll', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: '枫雨', // 必需
      href: 'https://github.com/fyypll' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:fyypll@163.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/fyypll'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/#/playlist?id=434341706'
        }
      ]
    },
    footer: { // 页脚信息
      createYear: 2023, // 博客创建年份
      copyrightInfo: '枫雨 | GPL-2.0 license', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
